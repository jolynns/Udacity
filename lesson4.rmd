...
```{r}
# first lets calculate it from scratch
...
print(paste0("The variance caluclaed by hand: ", Var_income))
...
print(paste0("The standard deviation caluclaed by hand: ", std_income))
...
Lets visualize this. I add in lines for one and two standard deviations but, because the data are not normal the standard deviations fall outside of the ranges defined by three sigma rule of thumb. 

```{r}
hist(income, probability = TRUE)
lines(density(income))
abline(v = s_mean, col = "darkblue", )
