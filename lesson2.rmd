...
####Histogram
A histogram is a graphical representation of the distribution of data, discrete intervals (bins) are decided upon to form widths for our boxes.
...
#### Skew
Positive Skew. A positive skew is when outliers are present along the right most end of the distribution
